...
class eCommerceCommande
{
	...
	public function fetchByCommandeId($commandeId, $siteId)
    {
        ...
        {
      	    $this->error="Error ".$this->db->lasterror();
            dol_syslog(get_class($this)."::fetchByCommandeId ".$this->error, LOG_ERR);
            return -1;
        }
    }
     ...
     */
    public function getAllECommerceCommandeIds($siteId)
    {
   		global $langs;
        ...
        {
      	    $this->error="Error ".$this->db->lasterror();
            dol_syslog(get_class($this)."::getAllECommerceCommandeIds ".$this->error, LOG_ERR);
            return -1;
        }
    }
}
