        ...
        if ( $siteDb->type == 2 ) {
            ...
            if ( $conf->product->enabled ) {
                ...
                foreach ($productExtrafields as $key => $label) {
                    if ( preg_match('/^ecommerceng_/', $key) )
                        continue;
        ...
        if ( $result > 0 ) {
            if ( $siteDb->type == 2 ) { // Woocommerce
                $result = ecommerceng_add_extrafields($db, $langs, [
                     ...
                     * "ecommerceng_online_payment_method_{$conf->entity}" => $conf->payment_method,
                     * -"ecommerceng_online_payment_method_title_{$conf->entity}" => $conf->payment_method_title,
                     * -"ecommerceng_online_payment_transaction_id_{$conf->entity}" => $conf->transaction_id, 
                     * -"ecommerceng_online_payment_date_{$conf->entity}" => $order->date_paid,
                     * 
                     */
                    [
                        'attrname'       => "ecommerceng_online_payment_site_id_{$conf->entity}",
                        'label'          => 'ECommercengWoocommerceOnlinePaymentSiteId',
                        'type'           => 'varchar',
                        'pos'            => 0,
                        'size'           => '255',
                        ...
                        'attrname'       => "ecommerceng_online_payment_method_{$conf->entity}",
                        'label'          => 'ECommercengWoocommerceOnlinePaymentMethod',
                        'type'           => 'varchar',
                        'pos'            => 0,
                        'size'           => '255',
                        'elementtype'    => 'commande',
                        ...
                        'attrname'       => "ecommerceng_online_payment_method_title_{$conf->entity}",
                        'label'          => 'ECommercengWoocommerceOnlinePaymentMethodTitle',
                        'type'           => 'varchar',
                        'pos'            => 0,
                        'size'           => '255',
                        'elementtype'    => 'commande',
                        ...
                        'attrname'       => "ecommerceng_online_payment_transaction_id_{$conf->entity}",
                        'label'          => 'ECommercengWoocommerceOnlinePaymentTransactionID',
                        'type'           => 'varchar',
                        'pos'            => 0,
                        'size'           => '255',
                        'elementtype'    => 'commande',
                        ...
                        'attrname'       => "ecommerceng_online_payment_date_{$conf->entity}",
                        'label'          => 'ECommercengWoocommerceOnlinePaymentDate',
                        'type'           => 'date',
                        'pos'            => 8,
                        'size'           => '',
                        'elementtype'    => 'commande',
